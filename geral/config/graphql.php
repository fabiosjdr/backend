...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'stand' => \App\GraphQL\Queries\Stands\StandQuery::class,
                'stands' => \App\GraphQL\Queries\Stands\StandsQuery::class,
            ],
            'mutation' => [
                'createStand' => \App\GraphQL\Mutations\Stands\CreateStandsMutation::class,
                'updateQuest' => \App\GraphQL\Mutations\Stands\UpdateStandsMutation::class,
                'deleteQuest' => \App\GraphQL\Mutations\Stands\DeleteStandsMutation::class,
            ],
            'middleware' => [],
            'method' => ['get', 'post'],
    ...
    'types' => [
       ...
       'Stands' => \App\GraphQL\Types\StandsType::class
    ],
